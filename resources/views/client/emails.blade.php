    ...
    <div class="modal fade" id="formModal" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="formModalLabel">Compose Email</h5>
                    ...
                    <div class="container-fluid">
                        <form id="form" action="{{route('user.communications')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="message" class="textarea-noresize form-control @error('message') is-invalid @enderror" name="message" cols="3" placeholder="">{{old('message')}}</textarea>
                                @error('message')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
