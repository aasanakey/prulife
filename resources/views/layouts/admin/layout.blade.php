...
<ul class="navbar-nav text-light" id="accordionSidebar">
    <li class="nav-item"><a class="nav-link" href="{{route('agent.dashboard')}}"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a></li>
    <li class="nav-item">
        ...
        <div id="collapseClient" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('admin.prospects')}}">Prospects</a>
                <a class="collapse-item" href="{{route('admin.clients')}}">Clients</a>
            </div>
        </div>
    </li>
    <li class="nav-item"><a class="nav-link" href="{{route('admin.insurance')}}"><i class="fas fa-store"></i><span>Insurance</span></a></li>
    <li class="nav-item"><a class="nav-link" href="{{route('admin.insurance')}}"><i class="fas fa-bookmark"></i><span>Insurance Policies</span></a></li>
    <li class="nav-item">
        ...
        <div id="collapseCliams" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('admin.claims')}}"><i class="fas fa-money-bill"></i>&nbsp;<span>Claims</span></a>
                {{-- <a class="collapse-item" href="{{route('user.claims.create')}}"><i class="fas fa-receipt"></i>&nbsp;<span>Make a Claim</span></a> --}}
            </div>
        </div>
    </li>
    <li class="nav-item"><a class="nav-link" href="{{route('admin.payments')}}"><i class="fas fa-money-bill"></i><span>Payments</span></a></li>
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseClient" aria-expanded="false" aria-controls="collapseClient">
        ...
        <div id="collapseClient" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('admin.emails')}}"><i class="fas fa-envelope"></i>&nbsp;<span>Email</span></a>
                <a class="collapse-item" href="{{route('admin.sms')}}"><i class="fas fa-sms"></i>&nbsp;<span>SMS</span></a>
            </div>
        </div>
    </li>
</ul>
    ...
    <li class="nav-item dropdown no-arrow">
        <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small">{{auth()->user()->firstname}}</span><img class="border rounded-circle img-profile" src="{{asset(auth()->user()->avatar)}}"></a>
            <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in">
                <a class="dropdown-item" href="{{route('admin.profile.edit',['admin'=>auth()->user()->id])}}"><i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Profile</a>
                ...
                href="{{route('admin.logout')}}"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Logout</a>
